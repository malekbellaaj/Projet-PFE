...
const SubjectDetail = lazy(() => import("../pages/matières/SubjectDetail"));
const CourseDetail = lazy(() => import("../pages/courses/CourseDetail"));
const DevoirDetail = lazy(() => import("../pages/devoirs/devoirDetail"));
const DevoirList = lazy(() => import("../pages/devoirs/devoirList")); 
...
const AppRoutes = () => {
  return (
    <Switch>
      ...
      <Route exact path={paths.subjectDetail} component={SubjectDetail} />
      <Route exact path={paths.courseDetail} component={CourseDetail} />
      <Route exact path={paths.devoirs} component={DevoirList} /> 
      <Route exact path={paths.devoirDetail} component={DevoirDetail} />
...
// const SubjectDetail = lazy(() => import("../pages/matières/SubjectDetail"));
// const CourseDetail = lazy(() => import("../pages/courses/CourseDetail"));
// const DevoirDetail = lazy(() => import("../pages/devoirs/devoirList")); 
// const discussions = lazy(() => import("../pages/discussions/DiscussionsPage")); 
