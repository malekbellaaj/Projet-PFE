...
// function getStepContent(step, formValues, setFaceImage, setHasCapturedFace) {
//   switch (step) {
//     case 0:
//       return <AddressForm />;
//     case 1:
//       return <Review formData={formValues} />;
//     case 2:
//       return <FaceDetectionForm setFaceImage={setFaceImage} setHasCapturedFace={setHasCapturedFace} />;
//     case 3:
//       return <PaymentForm />;
//     default:
//       throw new Error("Étape inconnue");
...
//       formData.append("acceptTerms", values.acceptTerms.toString());
//       if (faceImage) {
//         formData.append("faceImage", faceImage, "capture.jpg");
//       }
...
//                     </Alert>
//                   )}
//                   {getStepContent(activeStep, methods.getValues(), setFaceImage, setHasCapturedFace)}
//                   <Box sx={actionBoxStyle(activeStep)}>
//                     {activeStep !== 0 && (
//                       <Button
//                         onClick={handleBack}
