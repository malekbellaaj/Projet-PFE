...
export default function Info() {
  return (
    <Box>
      ...
      >
        ALTUS est une plateforme qui aide chaque élève à apprendre à lire à son
        rythme, avec des activités ludiques et adaptées.
      </Typography>
      ...
      <List dense>
        <ListItem>
          ...
          <ListItemText primary="Accès à des jeux et exercices pour apprendre à lire" />
        </ListItem>
        <ListItem>
          <ListItemIcon>
            <CheckCircleIcon color="primary" />
          </ListItemIcon>
          <ListItemText primary="Un parcours personnalisé selon ton niveau" />
        </ListItem>
        <ListItem>
          <ListItemIcon>
            <CheckCircleIcon color="primary" />
          </ListItemIcon>
          <ListItemText primary="Apprends tout en t’amusant !" />
        </ListItem>
      </List>
        ...
        >
          <List dense sx={{ pl: 1 }}>
            <ListItem sx={{ py: 0.5, alignItems: "flex-start" }}>
              ...
              <ListItemText
                primary="Un email de confirmation sera envoyé, contenant les informations de connexion."
