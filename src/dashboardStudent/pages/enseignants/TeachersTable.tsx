              ...
              if (!params.row.isAccepted) {
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    setTeachers((prev) =>
                      prev.map((teacher) =>
                        teacher.id === params.row.id ? { ...teacher, isAccepted: true } : teacher,
                      ),
                    );
                    Swal.fire({
          ...
          <IconifyIcon
            ...
            onClick={() => {
              MySwal.fire({
                ...
                preConfirm: () => {
                  const fullName = (document.getElementById('swal-fullName') as HTMLInputElement)
                    .value;
                  ...
                  const specialty = (document.getElementById('swal-specialty') as HTMLInputElement)
                    .value;
                  const cvUrl = (document.getElementById('swal-cvUrl') as HTMLInputElement).value;
                  setTeachers((prev) =>
                    prev.map((teacher) =>
...
//                   const registrationNumber = (document.getElementById('swal-registrationNumber') as HTMLInputElement).value;
//                   const phone = (document.getElementById('swal-phone') as HTMLInputElement).value;
//                   const email = (document.getElementById('swal-email') as HTMLInputElement).value;
//                   const cvUrl = (document.getElementById('swal-cvUrl') as HTMLInputElement).value;
//                   setTeachers((prev) =>
//                     prev.map((teacher) =>
//                       teacher.id === params.row.id
//                         ? { ...teacher, fullName, registrationNumber, phone, email, cvUrl }
//                         : teacher,
//                     ),
//                   );
//                 },
...
//       field: 'actions',
//       headerName: 'Action',
//       minWidth: 180, // Augmenté pour accueillir trois icônes
//       filterable: false,
//       sortable: false,
//       renderCell: (params) => (
//         <Stack direction="row" spacing={1}>
...
//             icon={
//               params.row.isAccepted
//                 ? 'mdi:checkbox-marked-circle' // ✅ Accepté
//                 : 'mdi:checkbox-blank-circle-outline' // ⭕ Non accepté
//             }
//             width={24}
//             height={24}
//             color={params.row.isAccepted ? 'green' : 'gray'}
...
//                     // Pour une API réelle :
//                     /*
//                     fetch(`/api/teachers/${params.row.id}`, {
//                       method: 'PATCH',
...
//         />
//       </Stack>
//       <Divider />  {/* une ligne de séparation entre liste des enseignant et contenu du table */}
//       <DataGrid
//         apiRef={apiRef}
//         columns={visibleColumns}
//         rows={teachers}
